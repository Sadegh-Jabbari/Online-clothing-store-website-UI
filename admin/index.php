                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table float-right" style="direction: rtl">
                                ...
                                <tr>
                                    <td><?php echo $num++; ?></td>
                                    <td><img src="../img/<?php echo $product_row['image']; ?>" width="100px" height="70px"></td>
                                    <td><?php echo $product_row['title']; ?></td>
                                    <td><?php echo $cat_row['cat_name']; ?></td>
                                    <td><?php echo $product_row['price']; ?></td>
                                    <td><a href="../products.php?id=<?php  echo $product_row['id']; ?>" class="btn btn-primary">مشاهده</a></td>
                                    <td>
